...
class EmailRow(Component):
    """An EmailRow component.
...
- id (string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(EmailRow, self).__init__(children=children, **args)

setattr(EmailRow, "__init__", _explicitize_args(EmailRow.__init__))
