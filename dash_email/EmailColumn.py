...
class EmailColumn(Component):
    """An EmailColumn component.
...
- id (string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(EmailColumn, self).__init__(children=children, **args)

setattr(EmailColumn, "__init__", _explicitize_args(EmailColumn.__init__))
