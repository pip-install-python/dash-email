...
NETWORK FILE: adapted from dash-documentation-boilerplate 1.6.29. The script
is the template's current copy plus this fork's bulletin check; these tests
are the template's reference minus the backend matrix (this repo is
Flask-only — see DIVERGENCES.md) plus the two bulletin tests at the end of
the check section.
