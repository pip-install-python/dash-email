...
def fixture_ledger(tmp_path, monkeypatch):
    ...
    reads = (
        ...
        + [_read(TODAY, "claudebot", "n/a", path="/components/email-structure/llms.txt", tier="page")] * 3
...
def test_the_tables_render_the_fixture_numbers(app_module, monkeypatch, fixture_ledger):
    ...
    assert "/components/email-structure/llms.txt" in day and "/sitemap.xml" in day
